...
''
  rules:
    ...
    - name: work
      ...
      atomic: true
      execute_after:
        - xrandr --output DisplayPort-0 --off --output DisplayPort-1 --off --output DisplayPort-2 --primary --mode 3440x1440 --pos 0x1080 --rotate normal --output HDMI-A-0 --noprimary --mode 1920x1080 --pos 760x0 --rotate normal --scale 0.5x0.5
        - wm-wallpaper
