...
''
  ...
  for_window [title="EVE - GeLaTe"] move window to position 1950 20
  for_window [title="EVE - R' GeLaTe"] floating enable
  for_window [title="EVE - R' GeLaTe"] resize set 1490 1420
  for_window [title="EVE - R' GeLaTe"] move window to position 1950 20
  ...
  bindsym $mod+e exec --no-startup-id qutebrowser -B "$HOME/.browser/Work" -s window.title_format " {perc}[Work]{title_sep}{current_title}"
  bindsym $mod+r exec ${kitty}/bin/kitty -e zsh -ic yazi
