{ colors, fonts }: ''
  ...
  for_window [title="EVE - R' hollyoake09"] floating enable
  for_window [title="EVE - R' hollyoake09"] resize set 1490 1420
  for_window [title="EVE - R' hollyoake09"] move window to position 975 20
  for_window [title="EVE - P' hollyoake09"] floating enable
  for_window [title="EVE - P' hollyoake09"] resize set 1490 1420
  for_window [title="EVE - P' hollyoake09"] move window to position 975 20
